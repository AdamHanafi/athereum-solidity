...
std::map<std::string, Instruction> const solidity::evmasm::c_instructions =
{
	...
	{ "BALANCEMC", Instruction::BALANCEMC },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::BALANCEMC,	{ "BALANCEMC",		0, 2, 1, false, Tier::Balance } },
	...
	{ Instruction::EMC,	        { "EMC",		    0, 0, 0, true, Tier::Special } },
	...
	{ Instruction::CALLEX,		{ "CALLEX",			0, 9, 1, true, Tier::Special } },
